...
},
{
    ...
    desc:" Advanced Site Creation Toolkit, Intuitive Drag-and-Drop Editor for Dynamic Websites and E-commerce Platforms (Green/White) Receive the WixPro website",
    ...
    return(
        <Container>
            ...
            <div className='main w-3/4 m-auto '>
                <h1 className=' pt-8 heading text-fontgrey font-normal text-5xl '>Best Website builders in the US</h1>
                <div className='mt-2 last-update flex items-center justify-between text-sm text-fontlightgrey p-3'>
                ...
                <div className='mt-2 w-4/5 flex items-center justify-between text-sm text-fontlightgrey p-3'>
                ...
                <div className='w-full flex flex-col mt-10 items-start gap-5 '>
                    <h5 className=' text-3xl text-fontgrey' >Related deals you might like for</h5> 
                ...
                <div className='flex justify-between items-center'>
                    <h5 className=' w-1/2 mt-8 font-normal text-fontdarkgrey text-3xl'>Sign up and get 
